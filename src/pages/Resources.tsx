...
const tutorials = [
  {
    ...
    description: 'Your first steps into Minecraft customization',
    level: 'Beginner',
    category: 'Fundamentals',
    comingSoon: true,
  },
  {
    title: 'Understanding Game Files',
    description: 'Navigate and edit Minecraft\'s configuration files',
    level: 'Beginner',
    category: 'Fundamentals',
    comingSoon: true,
  },
  {
    title: 'Command Block Basics',
    description: 'Create your first automated commands',
    level: 'Intermediate',
  ...
  },
  {
    ...
    description: 'Build computational circuits in Minecraft',
    level: 'Intermediate',
    category: 'Programming',
    comingSoon: true,
  },
  {
    ...
    description: 'Host your own multiplayer server',
    level: 'Advanced',
    category: 'Administration',
    comingSoon: true,
  },
  {
    title: 'Creating Data Packs',
    description: 'Write custom JSON to modify game behavior',
    level: 'Advanced',
    category: 'Programming',
    comingSoon: true,
  },
