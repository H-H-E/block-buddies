...
const valueProps = [
  {
    ...
    icon: Gamepad2,
    color: 'primary',
    description: 'Learn to "hack" your favorite game—the right way. Master real CS skills while having a blast.',
    benefits: [
      'File systems & config editing',
      'Networking & server concepts',
      'Logic & basic programming',
  ...
  },
  {
    ...
    icon: GraduationCap,
    color: 'secondary',
    description: 'Turn your Minecraft expertise into college-ready leadership experience.',
    benefits: [
  ...
  },
  {
    ...
    icon: Shield,
    color: 'accent',
    description: 'Free, safe, and actually educational. Real skills beyond screen time.',
    benefits: [
      '100% free program',
  ...
  {
    title: 'For Schools & Orgs',
    icon: Building2,
    color: 'gold',
    description: 'Partner with us to bring CS education to your community.',
    benefits: [
    ...
    cta: { text: 'Partner With Us', link: '/about#partners' },
