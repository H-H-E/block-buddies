...
duration_minutes: 45
prerequisites:
  - S07 pass or support-pass
mastery_gate_ids:
  - MG-S08-DO
  - MG-S08-EXPLAIN
  - MG-S08-DEBUG
fallback_path: Use a mentor-curated demo script and complete reflection checklist
---
...
- Worked Example (5m): mentor models concise demo story arc.
...
- Unlock: Fluency >= 1
- Outcome: compare first-session and final-session skill evidence.
