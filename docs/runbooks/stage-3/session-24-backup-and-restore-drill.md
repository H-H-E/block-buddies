...
By end of session, learner can understand backups as safety systems before risky changes.
...
- Core Quest (18 min): Change or break something in the prepared world, then restore from backup.
...
Make a backup of a tiny test world. This must land within the first 7 minutes so the learner feels oriented before touching harder server concepts.
...
- Debug: learner resolves or correctly diagnoses the prepared backup created after the mistake.
...
“Before a risky change, I should ___.”
